...
insert into tb_funcionarios(nome, idade, cpf, cadastrado, salario) values ("Raphael", 24, 14186036624, true, 15000.00);
insert into tb_funcionarios(nome, idade, cpf, cadastrado, salario) values ("Ricardo", 27, 12185036724, true, 100.00);
insert into tb_funcionarios(nome, idade, cpf, cadastrado, salario) values ("Davi", 24, 66183036622, true, 500.00);
insert into tb_funcionarios(nome, idade, cpf, cadastrado, salario) values ("Liza", 29, 32186734624, true, 1200.00);
